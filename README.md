...
1. Create a cloud backup/export of the systems you wish to scan. Download the backup and extract it locally. I've compiled documentation for a handful of popular cloud apps below.
